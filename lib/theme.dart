...
TextStyle titleCategory = GoogleFonts.poppins(
    color: Color(0xff272c2f), fontSize: 16, fontWeight: FontWeight.w400);
TextStyle titleJob = GoogleFonts.poppins(
    color: Color(0xff272c2f), fontSize: 20, fontWeight: FontWeight.w600);
TextStyle titleCompany = GoogleFonts.poppins(
...
TextStyle requirements = GoogleFonts.poppins(
